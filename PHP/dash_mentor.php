    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg')">
        <div class="container">
          <div class="row align-items-end justify-content-center text-center">
            <div class="col-lg-7">
              <h2 class="mb-0">Welcome <?php echo $_SESSION['tname']; ?></h2>
              <p></p>
            </div>
          </div>
        </div>
      ...
      <div class="site-section">
        <div class="container">
            <div class="row">
              <?php
                $sql="SELECT * from subjects where tid=$tid and school_id=$school_id";
                ...
                while($row=mysqli_fetch_array($result))
                {
                  ...
                  echo '<div class="col-lg-4 col-md-6 mb-4">
                        <form method="POST" action="dash_mentor.php">
                    <div class="course-1-item">
                        <figure class="thumnail">
                        <div class="category"><center><h3>'.$row["subname"].'</h3></center></div>  
                        </figure>
                        <div class="course-1-content pb-4">
                        <center><h3>'.$class,$div.'</h3></center>
                        <pre>
                        </pre>
                       ...
                       echo '
                        ...
                        <p><input type="hidden" name="subid" value="'.$row["subid"].'"><input type="hidden" name="div" value="'.$div.'">
                          <input type="submit" name="vsub" value="View This Subject" class="btn btn-primary btn-lg px-5">
                        </p>
                        </div>
                    </div></form>
                </div>';
