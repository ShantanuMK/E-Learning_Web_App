<?php
  ...
  echo $ttt[1];
      ...
      $wrong=0;
      $marks=0;
      $getexam="SELECT * FROM examq WHERE cid=15 and cvid=1 ";
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg')">
        <div class="container">
          <div class="row align-items-end justify-content-center text-center">
            <div class="col-lg-7">
              <h2 class="mb-0">Upload Topic Exam Questions</h2>
              <p></p>
            </div>
          </div>
        </div>
                          ...
                          <?php 
                            ...
                            while ($row=mysqli_fetch_array($resexam)) {
                              ...
                              echo '<div class="col-md-6 mb-4">
                                              <label><span style="color:red">Question '.$i.'</span></label>  
                                            </div><br>'.$row['eque'].'
                                            <div class="col-md-1 mb-1"></div>
                                            <div class="col-md-6 mb-4">
                                              <label>'.$row['eque'].'</label>
                                            </div>
                                        ...
                                        if ($row['equec']==$ttt[$i]) {
                                          echo '<div><label><span style="color:green">Correct</span></label></div>';
                                        }
                                        else {
