<?php
  ...
  if (isset($_POST['enter'])) {
    $_SESSION['eqnum']=$_POST['eqnum'];
    $_SESSION['ename']=$_POST['ename'];
    $_SESSION['edate']=$_POST['edate'];
    $_SESSION['etime']=$_POST['etime'];
    $_SESSION['edur']=$_POST['edur'];
...
<!--
    <div class="site-section">
        <div class="container">
            <form action="setexam.php" method="post" class="billing-form" enctype="multipart/form-data">
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <label for="standard">Exam Name</label>
                            <input type="text" name="ename" placeholder="" min="" class="form-control form-control-lg" required>
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="standard">Number of Questions</label>
                            <input type="number" name="eqnum" placeholder="" class="form-control form-control-lg" required>
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="standard">Date of Exam</label>
                            <input type="date" name="edate" placeholder="" class="form-control form-control-lg" required>
                        </div> 
                        <div class="col-md-12 form-group">
                            <label for="standard">Starting Time of Exam (HH-MM)</label>
                            <input type="time" name="etime" placeholder="" class="form-control form-control-lg" required>
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="standard">Ending Time of Exam (HH-MM)</label>
                            <input type="time" name="eetime" placeholder="" class="form-control form-control-lg" required>
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="standard">Duration of Exam (In Minutes)</label>
                            <input type="number" name="edur" placeholder="" class="form-control form-control-lg" required>
                        </div>    
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <input type="submit" name="enter" value="Continue" class="btn btn-primary btn-lg px-5">
