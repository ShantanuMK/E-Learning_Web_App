...
if(isset($_POST['login'])){
 ...
 $query = mysqli_query($conn, "SELECT * FROM teachers WHERE tpassword='$pass' AND temail='$user'");
 $datab=mysqli_fetch_array($query);
 $rows = mysqli_num_rows($query);
 if($rows == 1){
 $_SESSION['tid']=$datab["tid"];
 $_SESSION['tname']=$datab["tname"];
  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
        <div class="container">
            ...
            <form action="login_mentor.php" method="post" class="billing-form">
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <label for="username">Username</label>
                            <input type="text" name="temail" class="form-control form-control-lg" placeholder="Email">
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="pword">Password</label>
                            <input type="password" name="tpassword" class="form-control form-control-lg">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
