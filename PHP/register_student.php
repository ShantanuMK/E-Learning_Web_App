<?php 
  ...
  if (isset($_POST['add'])) {
    ...
    $get1=mysqli_query($conn,"SELECT * FROM students where sloginid='$sloginid' ");
    ...
    if ($num==0) {
      ...
      $semail=$_POST['semail'];
      $smnum=$_POST['smnum'];
      $insert=mysqli_query($conn,"INSERT INTO students (ssrno,sname,sstd,sdiv,sloginid,spassword,semail,smnum,school_id) VALUES ($ssrno,'$sname',$class,'$div','$sloginid','$spassword','$semail',$smnum,$schoolid) ");
      echo '<script>alert("Student Added Successfully")</script>';
      header("Location:view_class.php");
    }
    else {
      echo '<script>alert("Student Login-ID already exists. Please Enter Different Login-ID")</script> ';
    }
            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group">
                            <label for="standard">Login-ID</label>
                            <input type="text" name="sloginid" placeholder="" class="form-control form-control-lg" required>
                        </div>
                        <div class="col-md-12 form-group">
