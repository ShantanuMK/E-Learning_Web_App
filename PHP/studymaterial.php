    ...
    if($extension1=='pdf')
        {
              ...
              $sq="INSERT INTO subfiles (subid,filename,ftname,ftype) VALUES ($subid,'$file','$fname',2)";
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
               <div class="col-md-6 mb-4">
                <form action="studymaterial.php" method="post" class="billing-form" enctype="multipart/form-data">
                  ...
                  <form action="studymaterial.php" method="post" class="billing-form" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <label for="standard">Topic Name:</label>
                            <input type="text" name="saname" placeholder="" min="" class="form-control form-control-lg" required>
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="Fees">Study-Material file (Only in PDF format)</label>
                            <div>
            ...
            <div class="row">
              <div class="col-md-5 mb-4">
                ...
                <div class="col-lg-7 ml-auto align-self-center">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <input type="submit" name="enter" value="Upload New Material" class="btn btn-primary btn-lg px-5">
                            <a href="viewsub.php" class="btn btn-primary btn-lg px-5">Cancel</a>
                        </div>
                    </div>
                  </form>
                  ...
                  <form action="studymaterial.php" method="post" class="billing-form" enctype="multipart/form-data">
                <h2 class="section-title-underline mb-5">
                            <span><br>Study Material Uploaded</span>
                        </h2>
                        <ol>
                        <?php 
                        $query1="SELECT * FROM subfiles WHERE ftype=2 and subid=$subid";
