...
if(isset($_POST['login'])){
 ...
 $query = mysqli_query($conn, "SELECT * FROM students WHERE spassword='$pass' AND semail='$user'");
 $datab=mysqli_fetch_array($query);
 $rows = mysqli_num_rows($query);
 if($rows == 1){
 $_SESSION['sid']=$datab["sid"];
 $_SESSION['sname']=$datab["sname"];
 $_SESSION['cstd']=$datab['sstd'];
 $_SESSION['cdiv']=$datab['sdiv'];
  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
        <div class="container">
          ...
          <form action="login_student.php" method="post" class="billing-form">
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <label for="username">Login-ID</label>
                            <input type="text" name="semail" class="form-control form-control-lg" placeholder="Email">
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="pword">Password</label>
                            <input type="password" name="spassword" class="form-control form-control-lg">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
